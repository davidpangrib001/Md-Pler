...
module.exports = {
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.sendButtonDoc(id, text, wm, 'Menu', '.menu', { 
  ...
  contextInfo: { mentionedJid: [user],
    externalAdReply :{
    mediaUrl: 'PilarV2.github.io',
    mediaType: 2,
    description: 'https://chat.whatsapp.com/BkxbwERGX9x0mAhAsiDWxP', 
    title: 'ZEUSBOTZ-MD BY PILAR',
    body: '',
